...
function HouseMap({ places, places2, selectedAddress }: MapProps) {
  ...
  useEffect(() => {
    ...
    const initMap = () => {
      ...
      const centerPosition = new naver.maps.LatLng(37.4964496, 127.0297105);
          ...
          function (status: any, response: any) {
            ...
            const infoWindow = new naver.maps.InfoWindow({
              content: [
                ...
                `   <div style="font-size: 13px;">전용면적 : ${place.전용면적}m2<div>`,
                `   <div style="font-size: 13px;">주거공용면적: ${place.주거공용면적}m2<div>`,
                `   <div style="font-size: 13px;">방수: ${place.방수}개<div>`,
                `   <div style="font-size: 13px;">임대보증금: ${place.임대보증금}원<div>`,
                `   <div style="font-size: 13px;">월임대료: ${place.월임대료}원<div>`,
                `   <div style="font-size: 13px;">임대보증금1: ${place.임대보증금_1}원<div>`,
                `   <div style="font-size: 13px;">월임대료1: ${place.월임대료_1}원<div>`,
                `   <div style="font-size: 13px;">임대보증금2: ${place.임대보증금_2}원<div>`,
                `   <div style="font-size: 13px;">월임대료2: ${place.월임대료_2}원<div>`,
                `   <div style="font-size: 13px;">임대보증금3: ${place.임대보증금_3}원<div>`,
                `   <div style="font-size: 13px;">월임대료3: ${place.월임대료_3}원<div>`,
                "</div>",
              ].join(""),
              maxWidth: 300,
              anchorSize: {
