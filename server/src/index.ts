...
import { HouseInfo2 } from "./interFace";

const excelFilePath = path.join(__dirname, "xlsx", "house2.xlsx");
...
const jsonData = xlsx.utils.sheet_to_json<HouseInfo2>(worksheet);
...
const jsonFilePath = path.join(__dirname, "hoseInfoxlsx2.json");
